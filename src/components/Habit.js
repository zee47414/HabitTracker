  ...
  return (
    <div className="habit">
      <div className="habit-left">
        <img src="https://cdn-icons-png.flaticon.com/128/724/724927.png" className="fa-solid fa-hashtag" />
        <div>
      ...
      <div className="habit-right">
        <div className="log-btn" onClick={setId}>
          <img src="https://cdn-icons-png.flaticon.com/128/2838/2838779.png" className="fa-solid fa-calendar-week" />
          <h3>Week View</h3>
        </div>
        <div className="dlt-div">
        <img src="https://cdn-icons-png.flaticon.com/128/3221/3221845.png" onClick={handleDelete} icon="fa-solid fa-xmark" />
        </div>
